...
#
# Script generated by Vivado on Sat Jun 13 18:38:00 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_linebuff_0.sh
...
#
# Usage        : blk_mem_gen_linebuff_0.sh
#                blk_mem_gen_linebuff_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_linebuff_0.sh [-rerun]
#                blk_mem_gen_linebuff_0.sh [-reset_run]
#                blk_mem_gen_linebuff_0.sh [-clean]
#                blk_mem_gen_linebuff_0.sh [-reset_log]
#                blk_mem_gen_linebuff_0.sh [-help]
#
...
#                script (type 'blk_mem_gen_linebuff_0.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_gen_linebuff_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_linebuff_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../../../../opt/Vivado/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_gen_linebuff_0 xil_defaultlib.glbl -o blk_mem_gen_linebuff_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_gen_linebuff_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lovro/Documents/AMIX_GPU_FPGA/AMIX_GPU_FPGA.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_linebuff_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_linebuff_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_linebuff_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_linebuff_0.sh [-help]\n\
Usage: blk_mem_gen_linebuff_0.sh [-step]\n\
Usage: blk_mem_gen_linebuff_0.sh [-lib_map_path]\n\
Usage: blk_mem_gen_linebuff_0.sh [-rerun]\n\
Usage: blk_mem_gen_linebuff_0.sh [-reset_run]\n\
Usage: blk_mem_gen_linebuff_0.sh [-clean]\n\
Usage: blk_mem_gen_linebuff_0.sh [-reset_log]\n\
Usage: blk_mem_gen_linebuff_0.sh [-keep_index]\n\
Usage: blk_mem_gen_linebuff_0.sh [-noclean_files]\n\n\
